...
<div class="relative h-fit overflow-clip" class:mx-auto={center} style:width>
    ...
    <span
        class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-[0.82rem] font-semibold whitespace-nowrap"
    >
        <slot />
    </span>
</div>
...
<style lang="postcss">
    progress {
        ...
        box-shadow:
            inset 0.25rem 0.25rem rgba(255, 255, 255, 0.3),
    ...
    progress::-moz-progress-bar {
        @apply bg-green-700;
        box-shadow:
            inset 0.25rem 0.25rem rgba(255, 255, 255, 0.5),
