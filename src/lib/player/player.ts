...
export default class Player implements SaverLoader {
    ...
    get power(): Decimal {
        ...
        const artifactEffect =
            this._inventory.getArtifactEffects()[ArtifactEffectType.DAMAGE];
    ...
    get hp(): number {
        const artifactEffect = this._inventory
            .getArtifactEffects()
            [ArtifactEffectType.MAX_HEALTH].toNumber();
    ...
    get rarityMultiplier(): Decimal {
        ...
        const artifactMult =
            this._inventory.getArtifactEffects()[
                ArtifactEffectType.EQUIPMENT_RARITY
            ];
    ...
    get magicFind(): Decimal {
        ...
        const artifactMult =
            this._inventory.getArtifactEffects()[ArtifactEffectType.MAGIC_FIND];
