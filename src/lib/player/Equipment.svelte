...
>
    <span
        class="font-bold whitespace-nowrap pt-1"
        style:transform="scaleX({textScaleX})">{F(equipment.stat)}</span
    >
    <img
...
<style lang="postcss">
    button {
        box-shadow:
            inset 0.25rem 0.25rem rgba(255, 255, 255, 0.25),
