...
<section class="text-center">
    ...
    <div class="flex justify-center items-center">
        ...
        <button class="btn text-xl w-10" class:invisible={arena.isOnHighestStage} on:click={() => arena.nextStage()}>
